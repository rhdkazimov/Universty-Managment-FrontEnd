...
export const Announce = () => {
    ...
    const { data:usersAnnounceData,isLoading }:any|undefined = useQuery([EQueryKeys.getAllAnnounce],()=>{
        return userService.getAllAnnounce().catch((err)=>{console.log(err)
        })
      })
  ...
  return (
    <div className='announceBox'>
        ...
        <div>
        {
            ...
            {
                return (<div className="announceItem">
